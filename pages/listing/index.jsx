  ...
  return (
    <div className="font-Montserrat">
      <Shadow classname={styles.Nav_container}>
        ...
        <img onClick={() => router.push("/")} src="/images/logo.png" alt="logo" />
      ...
      <Shadow classname={`mt-[20px] w-[90%] p-[20px] flex flex-wrap ml-[50%] transform translate-x-[-50%] items-center`}>
        <TextInput className={"w-[300px] sm:w-[100%] mr-[30px] mb-[15px]"} label={"From"}></TextInput>
        <TextInput className={"w-[150px]  sm:w-[100%] mr-[30px] mb-[15px]"} label={"To"}></TextInput>
        <TextInput className={"w-[150px]  sm:w-[100%] mb-[15px] mr-[30px]"} label={"Depart"}></TextInput>
        <TextInput className={"w-[200px]  sm:w-[100%] mb-[15px] mr-[30px]"} label={"Departure Time"}></TextInput>
        <TextInput className={"w-[300px]  sm:w-[100%] mb-[15px] mr-[30px]"} label={"Passenger (Apart from patient)"}></TextInput>
      ...
      <Shadow classname={`mt-[20px] w-[90%] p-[10px] sm:hidden flex  ml-[50%] transform translate-x-[-50%] items-center`}>
        ...
        <div className="flex w-[50%]">
          <div className={`w-[50%] text-center`}>
            <h2 className="font-[600]">Commercial</h2>
          </div>
          <div className={`w-[50%] text-center`}>
            <h2 className="font-[600]">Chatered</h2>
          </div>
        </div>
      </Shadow>
      ...
      <button className="w-[90%] ml-[50%] transform translate-x-[-50%] rounded-[4px] my-[20px] px-[16px] py-[8px] bg-[#112211] text-white font-[600] text-[14px]">Show more results</button>
    </div>
  );
};
