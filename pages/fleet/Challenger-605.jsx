    ...
    <div className="font-poppins">
      ...
      <div className="text-center sm:px-10 px-28 text-[#848383]">
        ...
        <p>
          ...
          exceptional range, comfort, and technology. It&apos;s an ideal choice
          for long-distance missions and cases where patient comfort is a
          priority. The Bombardier Challenger 605 is a true luxury aircraft,
          offering exceptional range, comfort, and technology. It&apos;s an
          ideal choice for long-distance missions and cases where patient
          comfort is a priority. The Bombardier Challenger 605 is a true luxury
          aircraft, offering exceptional range, comfort, and technology.
          It&apos;s an ideal choice for long-distance missions and cases where
          patient comfort is a priority. The Bombardier Challenger 605 is a true
          luxury aircraft, offering exceptional range, comfort, and technology.
          It&apos;s an ideal choice for long-distance missions and cases where
        ...
        <div className="my-10">
          ...
          <p>
            Cabin Configuration: Spacious and luxurious, designed to provide the
            utmost comfort during the journey.
          </p>
        </div>
      </div>
      <img
