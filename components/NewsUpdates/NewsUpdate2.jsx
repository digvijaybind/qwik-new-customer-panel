...
const NewsUpdate2 = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col p-8 sm:p-2">
      ...
      {/* "Read More" Button */}
      <Link href="/blogs">
        <div className="w-[240px] h-[70px] bg-button-gradient mt-10 font-barlow font-semibold text-white flex justify-center items-center text-center rounded-md text-[24px] cursor-pointer hover:shadow-lg transition-shadow duration-300">
          Read More
        </div>
      </Link>
    </div>
