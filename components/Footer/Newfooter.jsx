...
const QwiklifData = [
  ...
  { name: "Work With Us", link: "/workWithus" }, // Ensure this is a valid link
...
const WorkWithQwiklif = [
  {
    Name: "For Aviation Firms / Aircraft Operators",
    Link: "/aviation-firms", // Added valid links
  },
  {
    Name: "For Hospitals",
    Link: "/hospitals",
...
const Newfooter = () => {
  return (
    <StyledSection
      ...
      className="sm:!px-[20px] pt-14 pb-8 hover:text-[#3788d8] font-sans"
    >
      <div className="grid grid-cols-5 sm:grid-cols-1 gap-4 lg:gap-6 content-center">
        <div className="flex flex-col content-center">
          ...
          {QwiklifData.map((data, index) => (
            <Link href={data.link} key={index}>
              <div className="text-[15px] text-[#fff] cursor-pointer mb-1 mt-1 content-center hover:text-[#3788d8]">
                {data.name}
              </div>
            </Link>
          ))}
      ...
      <div className="flex justify-center flex-col items-center font-sans pt-8 pb-4 sm:pt-[20px] sm:pb-[20px]">
        ...
        <div className="grid grid-cols-5 gap-5">
          ...
          <Link href="https://www.instagram.com/qwiklif/" target="_blank">
            <Image
              src={Insta}
              height={35}
              width={35}
          ...
          <Link href="https://www.tiktok.com/@qwiklif" target="_blank">
            <Image
              src={Tiktok}
              height={35}
              width={35}
          ...
          <Link href="https://twitter.com/qwiklif" target="_blank">
            <Image
              src={Twitter}
              height={35}
              width={35}
          ...
          <Link href="https://www.facebook.com/Qwiklif/" target="_blank">
            <Image
              src={Facebook}
              height={35}
              width={35}
