...
const UpdateSearch = ({
  ...
  return (
    <form onSubmit={handleSubmit} className={`${className}`}>
      ...
      >
        <div
          className={`bg-[#fff] w-[1100px] h-[220px] px-[20px] py-[35px] border-2  rounded-lg flex justify-center  items-center  rounded-5 ${className}`}
        >
          <div className="rounded-5 border border-solid border-gray-300 box-border w-full h-[112px] rounded-[5px] flex flex-row">
            ...
            >
              <div
                className={`${styles.Eachcell} hover:bg-[#e6f2f5] rounded-[10px] px-[10px] py-[10px]`}
            ...
            <div
              className={`${styles.Eachcell} hover:bg-[#e6f2f5] rounded-[5px] px-[10px] py-[10px] flex flex-col`}
            ...
            <div
              className={`${styles.Eachcell} hover:bg-[#e6f2f5] rounded-[5px]  px-[10px] py-[10px]`}
            >
