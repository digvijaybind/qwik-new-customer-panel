...
const UpdateSearch = ({
  ...
  return (
    <form onSubmit={handleSubmit} className={`${className}`}>
      <div
        className={`flex justify-center items-center mt-5 mb-5 w-full h-[350px] ${className}`}
      >
        <div
          ...
          <div className="rounded-5 border border-solid border-gray-300 box-border w-full h-[112px] rounded-[5px] flex flex-row">
            ...
            >
              ...
              >
                ...
                <ul
                  className={`w-full absolute bottom-0 translate-y-full bg-white shadow-md max-h-48 overflow-y-auto ${destinationFocus ? '' : 'hidden'
                    }`}
                >
                  {searchLoading && (
                    <div className="w-full flex justify-center py-3">
