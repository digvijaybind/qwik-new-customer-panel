...
const UpdatecareerCard = ({ image, height, width, headline, descripation }) => {
  return (
    <div className="block rounded-lg bg-white shadow-sm dark:bg-surface-dark cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-107  duration-30">
