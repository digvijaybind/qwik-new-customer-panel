...
const UpdatecareerCard = ({
  ...
  return (
    <div
      className="block rounded-lg bg-white shadow-sm dark:bg-surface-dark cursor-pointer transition ease-in-out font-poppins h-[480px] 3xl:h-[520px] 2xl:h-[500px] md:h-[680px] sm:h-[500px]"
      onClick={onClick}
    >
      ...
      <div className="p-6 text-surface text-center dark:text-white">
        ...
        <p className="mb-4 text-[16px] font-barlow text-sm">{descripation}</p>
        <button
          type="button"
