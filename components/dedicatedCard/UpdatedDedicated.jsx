...
const UpdatedDedicated = () => {
  return (
    <div
      className={`${styles.cardContainer} w-[590px] h-[210px] border-solid border-[1.5px] border-[#cdcdcd] rounded-2xl  cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-103 flex flex-col px-[25px] py-[10px] sm:w-[330px] sm:h-[250px] sm:px-[10px] sm:py-[10px]`}
    >
        ...
        <div className="grid grid-rows-2 gap-8 sm:gap-2 sm:grid-rows-[2fr,1.5fr] sm:items-center ">
          <div className="grid grid-cols-12 grid-rows-1 sm:grid-cols-1 sm:gap-y-5 sm:items-baseline sm:justify-start">
            ...
            <div className="time-date col-span-7 flex flex-row justify-around items-center sm:col-span-3 sm:justify-between">
              ...
              <div className="destination time flex flex-col items-center text-[#323232] font-black text-[18px] font-sans">
                20:05
                <span className="font-normal text-[12px] text-[#b4b3b3] font-sans">
                  dubai
                </span>
