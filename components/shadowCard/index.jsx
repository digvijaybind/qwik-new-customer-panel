  ...
  return (
    <div className="flex sm:flex-col items-center sm:justify-center shadow-md bg-white rounded-[10px] px-[15px] py-[15px] cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105  duration-300">
      ...
      <div className="px-[15px]">
        ...
        <button
          className={`${styles.Button} border-[#396CF0] mt-[20px] mb-[10px] sm:ml-[50%] sm:transform sm:translate-x-[-50%] border-[1px] px-[10px] py-[5px] rounded-[5px]`}
        >
          <p
            className={`text-[#396CF0] font-[600] ${styles.Text}`}
          >{`See Details >`}</p>
        </button>
      </div>
    </div>
