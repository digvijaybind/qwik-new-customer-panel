  ...
  return (
    <div className={`${styles.Wrapper} font-sans font-extrabold`}>
      <div className=" w-full flex justify-start items-start gap-8">
        <div className="bg-[#396CF0] overflow-hidden rounded-full sm:w-10 w-[70px] sm:h-10 h-[70px] flex justify-center items-center cursor-pointer">
          <Image
            src={img}
        ...
        <div className="w-fit flex flex-col gap-2">
          <div className="text-2xl sm:text-xl text-[#fff] font-bold">{title}</div>
