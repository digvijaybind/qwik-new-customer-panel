    ...
    >
      <div className="flex flex-col items-center">
        <div className="flex flex-col justify-center items-center">
          <div className="">No Chartered Air ambulance Available </div>
          <br />
        ...
        <div className="col-span-5 flex justify-center mt-10">
          <button className="w-[200px] h-[42px] bg-[#55CDF1] rounded-full font-extrabold text-[12px] text-[#fff] font-sans hover:text-[#000]">
            Contact us
          </button>
        </div>
      </div>
